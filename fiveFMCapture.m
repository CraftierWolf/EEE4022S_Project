...
addpath('C:\Users\ZUBAIR\Documents\University\UCT\Electrical Engineering 4th Year\EEE4022S\Sample Data\Data_recordings\new_89MHz');
%addpath('C:\Users\ZUBAIR\Documents\University\UCT\Electrical Engineering 4th Year\EEE4022S\Sample Data\89MHz_RSSI.xlsm');
%Code to get all the RSSI data from folder and write to an excel
%spreadsheet
pat='C:\Users\ZUBAIR\Documents\University\UCT\Electrical Engineering 4th Year\EEE4022S\Sample Data\Data_recordings\new_89MHz';  % Your folder
fil=fullfile(pat,'*.bin');
xlsfile = 'C:\Users\ZUBAIR\Documents\University\UCT\Electrical Engineering 4th Year\EEE4022S\Sample Data\89MHz_RSSI.xlsm';
d=dir(fil);
for k=1:numel(d)
  ...
  disp(file);
  [RSSIarr_,ave_power] = fileRSSI(150000000,250000,0.5,36.4,file);
...
%[ndata, text, alldata]=xlsread(xlsfile,'Sheet3');
